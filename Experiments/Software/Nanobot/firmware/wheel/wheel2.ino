...
void setup() {
    ...
    X.registerToCommandManager(cmdMgr, "X2"); 
    Y.registerToCommandManager(cmdMgr, "Y2");
    Z.registerToCommandManager(cmdMgr, "Z2");
    E0.registerToCommandManager(cmdMgr, "E0_2"); 
    E1.registerToCommandManager(cmdMgr, "E1_2");
    
    /* Do this for the rest of your devices */
    ring.registerToCommandManager(cmdMgr, "ring2");
    wash.registerToCommandManager(cmdMgr, "wash2");
